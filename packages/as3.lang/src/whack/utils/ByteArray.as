package whack.utils
{
    ...
    public class ByteArray implements IDataInput, IDataOutput
    {
        ...
        JSBridge.from static native function arrayBuffer(arg:*):ByteArray;

        JSBridge.from static native function byteArray(arg:*):ByteArray;

        /**
         * Returns the underlying `ArrayBuffer` JavaScript object used by the byte array.
         */
        JSBridge.to native function arrayBuffer():*;

        /**
         * Converts the byte array into a Node.js buffer.
         */
        JSBridge.to native function buffer():*;
