package
{
    ...
    {
        private static const m_ns:JSVal = JSBridge.lexical("Math");
        ...
        public static function max(val1:Number, val2:Number, ...rest : [Number]):Number
        {
            if (rest.length !== 0)
            {
                ...
                return m_ns.max.apply(undefined, JSBridge.toJSArray(rest));
            }
        ...
        public static function min(val1:Number, val2:Number, ...rest : [Number]):Number
        {
            ...
            {
                rest.unshift(val1, val2);
                return m_ns.min.apply(undefined, JSBridge.toJSArray(rest));
            }
